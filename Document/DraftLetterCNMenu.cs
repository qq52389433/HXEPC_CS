...
namespace AVEVA.CDMS.HXEPC_Plugins
{
    ...
    /// 起草红头文
    /// </summary>
    internal class DraftLetterCNMenu : ExWebMenu
    {
        ...
        public override enWebMenuState MeasureMenuState()
        {
            try
            {
                ...
                if (project != null)
                {
                    ...
                    //{
                    //if (parentProject.Code == "发文" && parentProject.ParentProject.Code == "信函")
                    //if (
                    //    //项目管理类
                    //    ((parentProject!=null && parentProject.ParentProject != null &&
                    //    parentProject.Code == "信函" && parentProject.ParentProject.Code == "发文") ||
                    //    (parentProject.ParentProject != null && parentProject.ParentProject.ParentProject != null &&
                    //    parentProject.ParentProject.Code == "信函" &&
                    //    parentProject.ParentProject.ParentProject.Code == "发文")
                    //   )||
                    //   //运营管理类
                    //    ((parentProject != null && parentProject.ParentProject != null &&
                    //     parentProject.Code == "发文" && parentProject.ParentProject.Code == "信函") ||
                    //     (parentProject.ParentProject != null && parentProject.ParentProject.ParentProject != null &&
